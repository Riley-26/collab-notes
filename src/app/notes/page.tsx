    ...
    return (
        <div className="flex flex-col w-full h-full">
            <div className="flex w-full h-2/3">
                <div className="w-1/3 p-4 flex flex-col m-2 rounded-lg bg-[rgb(35,35,35)]">
                ...
                <div className="w-2/3 flex flex-col">
                    <div className="w-2/2 h-1/2 p-4 flex flex-col m-2 rounded-lg bg-[rgb(35,35,35)]">
            ...
            <div className="flex w-full h-1/3">
                <div className="w-2/3 p-4 flex flex-col m-2 rounded-lg bg-[rgb(35,35,35)]">
